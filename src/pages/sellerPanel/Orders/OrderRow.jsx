                ...
                <div className="grid grid-cols-12 gap-2 text-center items-center text-sm">
                    ...
                    <div className="col-span-1">
                        <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-50 text-gray-800 hover:bg-blue-100 rounded-lg text-sm font-medium transition-all duration-200 border border-blue-200"
                        >
                ...
                <div className="mx-6 mb-4 bg-gradient-to-r rounded-xl border shadow-sm">
                    <div className="p-5">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="w-8 h-8 bg-[#EABF9F] rounded-full flex items-center justify-center">
                                <svg className="w-4 h-4 text-balack" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-400 font-modam">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-lg font-medium text-gray-900">{order.totalAmount} تومان</span>
                            </div>
                        </div>
                    </div>
                </div>
