...
const ProductQuestions = ({ productId }) => {
    ...
    if (loading) {
        return (
            <div className="bg-[#fef8e7] rounded-xl p-6 shadow border border-gray-200">
    ...
    return (
        <div className="bg-[#fef8e7] rounded-xl p-6 space-y-6 shadow border border-gray-200">
            <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold">پرسش‌های مشتریان</h3>
            </div>
            ...
            {sortedQuestions.length === 0 ? (
                <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">هنوز پرسشی ثبت نشده است</p>
                </div>
            ) : (
                            ...
                            <div className="pr-8 mb-4">
                                <div className="bg-green-50 rounded-lg p-4 border border-green-100">
                                    <div className="flex items-start gap-3">
                                        <FaReply className="text-green-600 text-sm mt-1" />
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="pr-8">
                            {activeAnswerForm !== question.id ? (
                                <button
                                    ...
                                    className="text-blue-600 text-sm hover:text-blue-700 transition-colors flex items-center gap-2"
                                >
                                    <FaReply />
                                ...
                                <div className="bg-white rounded-lg p-4 border border-gray-200 space-y-3">
                                    <textarea
                                        ...
                                        className="w-full p-3 border border-gray-300 rounded-lg resize-none text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                        rows="3"
                                    />
