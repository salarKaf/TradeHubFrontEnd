  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden bg-[linear-gradient(to_bottom,_#1E212D_0%,_#1E212D_35%,_#626C93_100%)] font-rubik">
      ...
      <div className="relative w-full max-w-3xl">
        ...
        <div className="relative z-20 bg-[#8D8D8D33] border border-[#00000080] backdrop-blur-xl shadow-2xl rounded-3xl p-10 space-y-6 text-right">
          <div>
            <input
              type="text"
              value={storeName}
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-400 placeholder:text-right focus:outline-none focus:ring-2 focus:ring-[#EABF9F]"
            />
          </div>
          ...
          <div className="relative">
            <input
              ...
              placeholder="لوگوی فروشگاه خود را وارد کنید"
              className="w-full px-4 py-3 pl-10 rounded-xl border border-gray-400 placeholder:text-right focus:outline-none focus:ring-2 focus:ring-[#EABF9F]"
            />
            <img
              src="/TradePageimages/icon-store-logo.png"
              className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5"
              alt="store logo icon"
            />
            <span className="text-sm text-gray-500 absolute -bottom-6 right-0">(اختیاری)</span>
          </div>

          <div className="flex justify-between pt-6">
            <button className="bg-[#EABF9F] px-6 py-2 rounded-full font-bold hover:bg-[#e7b78e] transition">
              قبلی
            </button>
            <button className="bg-[#EABF9F] px-6 py-2 rounded-full font-bold hover:bg-[#e7b78e] transition">
              بعدی
